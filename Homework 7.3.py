...
"""
Пункт 3. Реализовать программу работы с органическими клетками,
состоящими из ячеек. Необходимо создать класс Клетка.
В его конструкторе инициализировать параметр, соответствующий количеству ячеек
клетки (целое число). В классе должны быть реализованы методы перегрузки
...
class Cell:
    ...
    def __sub__(self, other):
        return other.quantity - self.quantity \
            if (other.quantity - self.quantity) < 0 \
            else print('Внимание! Отрицательное значение при вычитании!')
...
cells1 = Cell(12)
cells2 = Cell(15)
print(f'Исходное число ячеек в 1-й клетке: {cells1}')
print(f'Сложение ячеек двух клеток: {cells1 + cells2}')
print(f'Вычитание ячеек 2-й клетки из 1-й: {cells1 - cells2}')
print(f'Умножение ячеек двух клеток {cells1 * cells2}')
print(f'Деление ячеек 1-й клетки на 2-ю: {cells1 / cells2}')
print(f'Организация ячеек по рядам: {cells2.make_order(5)}')
print(f'Организация ячеек по рядам: {cells1.make_order(10)}')
