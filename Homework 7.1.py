...
"""
Пункт 1. Реализовать класс Matrix (матрица). Обеспечить перегрузку конструктора
...
list_lists_01 = [[31, 22], [3, 5, 32], [3, 5, 8, 3]]
list_lists_02 = [[37, 43], [2, 4, 6], [8, 3, 7, 1]]
list_lists_03 = [[51, 86], [-1, 64, -8], [0, 0, 0, 0]]

matrix01 = Matrix(list_lists_01)
matrix02 = Matrix(list_lists_02)
matrix03 = Matrix(list_lists_03)
matrix04 = matrix01 + matrix02 + matrix03
